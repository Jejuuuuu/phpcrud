...
if (isset($_POST['updatepassword'])) {
  ...
  if ($newPassword === $confirmPassword) {
      ...
      if ($con->updatePassword($user_id, $hashedPassword)) {
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="profile-info">
        ...
        <div class="info-body">
          <p><strong>First Name:</strong> Naruto</p>
          <p><strong>Last Name:</strong> Uzumaki</p>
          <p><strong>Birthday:</strong> July 12, 2004</p>
        </div>
      </div>
    </div>
    </div>
    ...
    <div class="col-md-12">
      <div class="address-info">
        ...
        <div class="info-body">
          <p><strong>Street:</strong> Konoha </p>
          <p><strong>Barangay:</strong> Balintawak </p>
          <p><strong>City:</strong> Lipa City </p>
          <p><strong>Province:</strong> Region IV-A (Calabarzon) </p>
